...
async componentDidMount(){
    ...
    const imageUrl = pokemonRes = pokemonRes.data.sprites.front_default;
    ...
    // Convert decimeter to Feet..... The + 0.00001 * 100 /100 is for rounding to 2 decimal places
    const height = 
